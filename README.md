...
| ETTh1 | 192 | 0.4280 | 0.4270 |
| ETTh1 | 336 | 0.4811 | 0.4547 |
| ETTh1 | 720 | 0.5076 | 0.4922 |
| ETTh1 | 平均 | 0.4482 | 0.4430 |

这样的结果表明随着预测时间范围的增加（从96到720），预测误差也相应增加，这是符合预期的。MSE从0.3762增加到0.5076，MAE从0.3981增加到0.4922。

看起来你的模型工作得很好！如果你想继续测试其他数据集，可以按照相同的方式运行其他脚本，然后将结果添加到这个表格中。
